...
setup_database() {
    log_info "Setting up TimeTracker Pro database..."
...
EOF
    ...
    echo "DATABASE_URL=postgresql://timetracker_user:$DB_PASSWORD@localhost:5432/timetracker_pro" >> .env.db
    chmod 600 .env.db
...
# Setup application
setup_application() {
    log_info "Setting up TimeTracker Pro application..."
...
# Start services
start_services() {
    log_info "Starting TimeTracker Pro services..."
...
main() {
    log_info "Starting TimeTracker Pro On-Premises Installation"
    log_info "================================================"
    ...
    log_success "TimeTracker Pro installation completed!"
    log_info ""
    log_info "Next steps:"
    ...
    log_info ""
    log_info "Application logs: /var/log/timetracker-pro/"
    log_info "PM2 management: pm2 status, pm2 logs, pm2 restart timetracker-pro"
}
